...
| 插件 | 说明 | MCP 端点 | 状态 |
| --- | --- | --- | --- |
| [`fin-winner`](plugins/fin-winner) | 管理 Fin Winner 投资记录：自选股、个股思考、估值、前瞻洞察、交易策略、分析报告 | `https://xcanity.com/fw-plugin/mcp` | 可用 |
| `ai-counter` | — | — | 规划中 |
| `clipmusic` | — | — | 规划中 |
...
claude plugin install fin-winner@xcanity
```
...
codex plugin add fin-winner@xcanity
```
